...
func TestSql(t *testing.T) {
	t.Run("type & converter test", func(t *testing.T) {
		...
		tests := []test{
			...
			{id: 12, typeName: data.FieldTypeNullableTime, value: ptrOf(time.Date(2017, time.November, 11, 00, 00, 01, 00000000, time.Local).UTC())},
			{id: 13, typeName: data.FieldTypeNullableTime, value: ptrOf(time.Date(2017, time.November, 11, 00, 00, 02, 123456789, time.Local).UTC())},
